...
// let fruits = ["apple","mango","banana","pineapple","custardApple"]
// fruits.push("orange");
// fruits.shift();
...
// let number = [1,2,3,4,5,7,8,0,6,9];
...
//     }
//--------------------------------------------------------------------------------------------------------------------------------
// 10. Use `setTimeout()` to log `"Time’s up!"` after 2seconds.SHERYIANS CODING SCHOOL
